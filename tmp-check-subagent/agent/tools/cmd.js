...
export class ExecTool extends Tool {
    ...
    constructor(options = {}) {
        ...
        this.denyPatterns = (options.denyPatterns ?? DEFAULT_DENY_PATTERNS).map((pattern) => new RegExp(pattern, "i"));
    }
    get name() {
        return "exec";
    }
    ...
    async execute(params) {
        ...
        try {
            const result = await this.runCommand(command, {
                timeoutSeconds: typeof timeout === "number" ? timeout : this.defaultTimeoutSeconds,
